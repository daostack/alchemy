...
# npm explore ganache-cli -- npm start --  -h 0.0.0.0 --networkId 1512051714758 --quiet --mnemonic "myth like bonus scare over problem client lizard pioneer submit female collect" > /dev/null &
