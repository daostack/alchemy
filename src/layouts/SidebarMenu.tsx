      ...
      <div>
        <div className={css.daoName}>
          <Link to={"/dao/" + dao.address} onClick={this.handleCloseMenu}>
            <b className={css.daoIcon} style={{ backgroundImage: bgPattern.toDataUrl() }} />
            <em />
            <span>{dao.name}</span>
          </Link>
        </div>
        <div className={css.daoDescription}>
          {dao.name === "dxDAO" ? (
            <p>
              ...
              <a
                href="https://cloudflare-ipfs.com/ipfs/QmRQhXUKKfUCgsAf5jre18T3bz5921fSfvnZCB5rR8mCKj"
                target="_blank"
                rel="noopener noreferrer"
              >
                Participation Agreement
              </a>
              , which includes the terms of participation in the dxDAO
            </p>
          ) : dao.name === "Meme" ? (
            <p>
              <a
                href="https://docs.google.com/document/d/1iJZfjmOK1eZHq-flmVF_44dZWNsN-Z2KAeLqW3pLQo8"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <p>
              ...
              <a href="https://t.me/dhack0" target="_blank" rel="noopener noreferrer">
                t.me/dhack0
              </a>
            </p>
          ) : dao.name === "Identity" ? (
            <p>
              ...
              <a
                href="https://docs.google.com/document/d/1_aS41bvA6D83aTPv6QNehR3PfIRHJKkELnU76Sds5Xk"
                target="_blank"
                rel="noopener noreferrer"
              >
                How to register.
        ...
        <div className={css.daoNavigation}>
          ...
          <ul>
            ...
            <li>
              <TrainingTooltip
                placement="topLeft"
                overlay={"List of entities (DAOs and individuals) that have voting power in the DAO"}
              >
            ...
            <ul>
              ...
              <li>
                <TrainingTooltip overlay="List of all DAOs accessible by Alchemy" placement="right">
                  <Link to="/daos" onClick={this.handleCloseMenu}>
                    All DAOs
                  </Link>
                </TrainingTooltip>
              </li>
              ...
              <li>
                <a href="https://daostack.zendesk.com/hc" target="_blank" rel="noopener noreferrer">
                  Help Center
                </a>
              </li>
              <li>
                <a href="https://hub.gendao.org/" target="_blank" rel="noopener noreferrer">
                  Get Involved
                </a>
              </li>
              <li>
              ...
              <li>
                <a
                  href="https://cloudflare-ipfs.com/ipfs/Qmf4HafH1QiryBun7j2g9inp78Njrkt635WJ943rBQyWyy"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Privacy Policy
              ...
              <li className={css.daoStack}>
                <a href="http://daostack.io" target="_blank" rel="noopener noreferrer">
                  <img
                    src={
                      this.props.daoAvatarAddress ? "/assets/images/Icon/dao-logo.svg" : "/assets/images/Icon/dao-logo-gray.svg"
                    }
                  />{" "}
                  DAOstack
                </a>
...
const ETHBalance = (props: IEthProps) => {
  ...
  return (
    <li key="ETH">
      <strong>{formatTokens(data)}</strong> ETH
    </li>
  );
};
...
const SubscribedSidebarMenu = withSubscription({
  ...
  createObservable: (props: IProps) => {
    if (props.daoAvatarAddress) {
      ...
      const promise = axios
        .get(
          `https://disqus.com/api/3.0/threads/listPosts.json?api_key=KVISHbDLtTycaGw5eoR8aQpBYN8bcVixONCXifYcih5CXanTLq0PpLh2cGPBkM4v&forum=${
            process.env.DISQUS_SITE
          }&thread:ident=${props.daoAvatarAddress}&since=${lastAccessDate}&limit=1&order=asc`
        )
        .then(
          (response: AxiosResponse<any>): IHasNewPosts => {
            if (response.status) {
