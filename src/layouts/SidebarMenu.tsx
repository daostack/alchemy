              ...
              {!testNet &&
                <>
                  <li><a className="externalLink"
                    href={(network === "main") ? process.env.ALCHEMY_URL_V2_MAINNET : process.env.ALCHEMY_URL_V2_XDAI}
                    target="_blank" rel="noopener noreferrer">Switch to v2</a></li>
                  {(network === "main") ?
                    <li><a className="externalLink" href={process.env.ALCHEMY_URL_V1_XDAI} target="_blank" rel="noopener noreferrer">Switch to xDAI</a></li>
                    : (network === "xdai") ?
                      <li><a className="externalLink" href={process.env.ALCHEMY_URL_V1_MAINNET} target="_blank" rel="noopener noreferrer">Switch to Mainnet</a></li>
                      : ""
                  }
                </>
              }
