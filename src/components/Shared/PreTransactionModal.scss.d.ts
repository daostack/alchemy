...
export const genesisProtocolLink: string;
export const passFailConditions: string;
export const passCondition: string;
export const failCondition: string;
export const instructionsOpen: string;
