              ...
              <div className={css.schemeRegistrarForm}>
                <Formik
                  initialValues={{
                    ...
                    scheme: arc.contractAddresses.ContributionReward,
                    title: "",
                    url: ""
                  } as FormValues}
                    ...
                    <Form noValidate>
                      ...
                      <div className={css.schemeFields}>
                        <div className={css.schemeSelectContainer}>
                          ...
                          >
                            <option value={arc.contractAddresses.ContributionReward}>Contribution Reward</option>
                            <option value={arc.contractAddresses.SchemeRegistrar}>Scheme Registrar</option>
                            <option value={arc.contractAddresses.GenericScheme}>Generic Scheme</option>
