...
// Here is where we will edit the form inputs in order to fullfill the form requirements
// we couldnt finish since the schemeInfo always convert itself as a GenericScheme
class CreateSignalSchemeProposal extends React.Component<IProps, IState> {
...
export default connect(mapStateToProps, mapDispatchToProps)(CreateSignalSchemeProposal);
