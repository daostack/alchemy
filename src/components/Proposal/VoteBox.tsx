...
export default class VoteBox extends React.Component<IProps, IState> {
  ...
  public render() {
    ...
    var yesPercentage = dao.reputationCount ? Math.round(proposal.votesYes / dao.reputationCount * 100) : 0;
    var noPercentage = dao.reputationCount ? Math.round(proposal.votesNo / dao.reputationCount * 100) : 0;
