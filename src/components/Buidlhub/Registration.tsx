        ...
        this.setState({
            ...
            try {
                if(this.props.wallet && email) {
                    let client:IBuidlhubClient = new BuidlhubClient();
                    let r = await client.register({
                        email,
...
const EmailInput  = (props:any) => {
    let bClass = props.disabled?css.sendButtonDisabled:css.sendButton;
    return (
        ...
        <div className={css.inputWrapper}>
            ...
            <div className={css.sendButtonWrapper}>
                ...
                <button className={bClass} 
                    ...
                    onClick={e=>props.sendToBHub(props.email)}>Send</button>
