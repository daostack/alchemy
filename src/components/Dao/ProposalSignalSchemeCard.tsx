...
// This component is used to render SignalSchemeCard.
...
const ProposalSignalSchemeCard = (props: IProps) => {
...
export default withSubscription({
  wrappedComponent: ProposalSignalSchemeCard,
...
const SignalProposalDetail = (props: IProposalDetailProps) => {
...
const SubscribedSignalProposalDetail = withSubscription({
  wrappedComponent: SignalProposalDetail,
  loadingComponent: <div>Loading...</div>,
  errorComponent: null,
