...
interface IDaoCustomInfo {
  [network: string]: { [address: string]: ReactElement | string };
}
  ...
  rinkeby: {
    "0x9003196e314e03dae65f0bf26788befc714d68a1": (
      <>
        ...
        <div>Visit the <Link to={"/dao/0x9003196E314e03daE65f0bF26788befC714D68a1/plugins/"}>Proposals page</Link> to make a proposal to the DAO or vote on existing proposals.</div>
      </>
    ),
  },
  kovan: {
