...
export const settings = {
  ...
  xdai: {
    ...
    graphqlSubscribeToQueries: false,
    web3Provider:  process.env.ARC_WEB3PROVIDER || "wss://dai-trace-ws.blockscout.com/ws",
    web3ProviderRead:  process.env.ARC_WEB3PROVIDERREAD || "wss://dai-trace-ws.blockscout.com/ws",
    ipfsProvider: process.env.ARC_IPFSPROVIDER || "https://api.thegraph.com:443/ipfs-daostack/api/v0",
    txSenderServiceUrl: "",
