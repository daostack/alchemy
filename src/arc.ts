...
const settings = {
  ...
  staging: {
    graphqlHttpProvider: "https://rinkeby.subgraph.daostack.io/subgraphs/name/v19",
    graphqlWsProvider: "wss://ws.rinkeby.subgraph.daostack.io/subgraphs/name/v19",
  ...
  production: {
    graphqlHttpProvider: "https://subgraph.daostack.io/subgraphs/name/v19",
    graphqlWsProvider: "wss://ws.subgraph.daostack.io/subgraphs/name/v19",
